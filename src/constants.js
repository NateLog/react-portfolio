...
export const LIGHT_COLORS = {
  ...
  "--color-primary-700": "rgba(250, 238, 231, 255)",
  "--color-primary-900": "hsl(256deg 100% 20%)",
  "--color-primary-contrast": "rgba(250, 238, 231, 255)",
  "--color-secondary-500": "hsl(328deg 100% 50%)",
  "--color-decorative-100": "hsl(50deg 100% 94%)",
  "--color-decorative-200": "hsl(50deg 100% 90%)",
  "--color-decorative-300": "hsl(50deg 100% 94%)",
  "--color-decorative-500": "hsl(50deg 100% 94%)",
  "--color-decorative-600": "hsl(50deg 100% 60%)",
  "--color-decorative-700": "rgba(250, 238, 231, 255)",
...
export const DARK_COLORS = {
  "--color-text": "rgba(250, 238, 231, 255)",
  "--color-primary-100": "hsl(50deg 100% 90%)",
  "--color-primary-300": "hsl(50deg 100% 70%)",
  "--color-primary-500": "rgba(250, 238, 231, 255)",
  ...
  "--color-decorative-500": "hsl(256deg 20% 4%)",
...
LIGHT_COLORS["--color-selection-text"] = LIGHT_COLORS["--color-text"];
...
DARK_COLORS["--color-selection-text"] = DARK_COLORS["--color-text"];
